...
public void actionPerformed(ActionEvent ev) {
	...
	if(o == button1) {
		...
		if(tf3.getText().length()>10) {
			JOptionPane.showMessageDialog(this, "비밀번호가 매우 길어요! 조금 줄여주세요!");
			return;
			
		}
		if(tf5.getText().length()>=3) {
			JOptionPane.showMessageDialog(this, "주소는 두글자만 입력가능해요!");
			return;
...
public void keyTyped(KeyEvent e) {
	   ...
	   if (o == tf4) {
	         ...
	         System.out.println(tf3.getText().length());

...
public class CustomerMyView extends JPanel implements ActionListener,ItemListener
{
	...
	ImageIcon image0, image1, image2, image3, image4, image5, image6, image7, image8, image9, image10;
	...
	public  CustomerMyView(String id) {
		...
		pan9.add(lab12,cbi);
		 ...
		 //스탬프 부분
	      if(!(dao.countHistory(myid)==0)) {
	         if(dao.countHistory(myid)%10==1) {
	         lab12.setIcon(image10);}
	         else if(dao.countHistory(myid)%10==2) {
	            lab12.setIcon(image2);}
	         else if(dao.countHistory(myid)%10==3) {
	            lab12.setIcon(image3);}
	         else if(dao.countHistory(myid)%10==4) {
	            lab12.setIcon(image4);}
	         else if(dao.countHistory(myid)%10==5) {
	            lab12.setIcon(image5);}
	         else if(dao.countHistory(myid)%10==6) {
	            lab12.setIcon(image6);}
	         else if(dao.countHistory(myid)%10==7 ) {
	            lab12.setIcon(image7);}
	         else if(dao.countHistory(myid)%10==8) {
	            lab12.setIcon(image8);}
	         else if(dao.countHistory(myid)%10==9) {
	            lab12.setIcon(image9);}
	         else if(dao.countHistory(myid)%10==0) {
	            lab12.setIcon(image10);}
	      }
	      else {
	         lab12.setIcon(image1);
	      }

...
public class MenuMain extends JFrame implements ActionListener {
		...
		JRadioButton c,d,a;
		MenuDAO dao;
		String MenuTable[][] = new String[0][3];
		String[] colTable = {"코드", "상품명", "가격"};
		DefaultTableModel modelTable = new DefaultTableModel(MenuTable,colTable) {
			/**
			 * 
			 */
	...
	JTable tableMenu = new JTable(modelTable);

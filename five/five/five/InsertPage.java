	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == insertBtn) {
			if(txt1.getSelectedItem() == "커피") {
				...
				int count =dao.CountCNO(MenuMain.modelTable, "C");
				if(MenuDAO.count < 10) {
					sur1 = "C00" + count;
				}else if(MenuDAO.count <100) {
					sur1 = "C0" + count;
				} else 
					sur1 = "C" + count;
			}else if(txt1.getSelectedItem() == "디저트") {
				int count = dao.CountCNO(MenuMain.modelTable,"D");
				if(MenuDAO.count < 10) {
					sur1 = "D00" + count;
				}else if(MenuDAO.count <100) {
					sur1 = "D0" + count;
				...
				int count = dao.CountCNO(MenuMain.modelTable, "A");
				if(MenuDAO.count < 10) {
					sur1 = "A00" + count;
				}else if(MenuDAO.count <100) {
					sur1 = "A0" + count;
			...
			dao.insertTable1(MenuMain.modelTable1, sur1);

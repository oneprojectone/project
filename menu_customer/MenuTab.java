...
public class MenuTab extends JPanel implements ActionListener, ItemListener {
	...
	public MenuTab() {
		...
		JPanel panelEastSize = new JPanel(new GridLayout(3, 1));
		JLabel labelEastSizeAddPrice1 = new JLabel("large 선택 시", SwingConstants.CENTER);
		JLabel labelEastSizeAddPrice2 = new JLabel("500원이 추가됩니다.", SwingConstants.CENTER);
		...
		panelEastSize.add(labelEastSizeAddPrice1);
		panelEastSize.add(labelEastSizeAddPrice2);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnSearch) {
			...
			DTO_History history = new DTO_History(1, user.getpID(), menu.getcName(), mSize, mTem);
